    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-20 py-8 sm:py-0">
        ...
        >
          <a
            href="#projects"
            className="px-8 py-3 backdrop-blur-sm bg-blue-500/10 border border-blue-500 text-blue-400 rounded-lg font-semibold hover:bg-blue-500/20 hover:border-blue-400 transform hover:scale-105 transition-all duration-300"
          >
            View My Work
          </a>
          <a
        ...
        <div
          className={`flex gap-6 justify-center mt-12 fade-in ${
            isLoaded ? "is-visible" : ""
          }`}
